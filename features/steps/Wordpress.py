...
def step_impl(context):
    ...
    assert driver.current_url == "http://localhost/wordpress/wp-admin/"
...
def step_impl(context):
    ...
    assert driver.current_url == "http://localhost/wordpress/wp-admin/users.php"
...
def step_impl(context):
    ...
    assert driver.current_url == "http://localhost/wordpress/wp-login.php"
...
def step_impl(context):
    for row in context.table:
        ...
        assert driver.find_element_by_xpath("//div[@id='message'][1]/p[1]").text == "Neuer Benutzer erstellt. Benutzer bearbeiten"
...
def step_impl(context):
    ...
    ActionChains(driver).move_to_element(driver.find_element_by_xpath("//*[@id='wp-admin-bar-top-secondary']")).perform()
...
def step_impl(context, Benutzername):
    ...
    assert driver.find_element_by_xpath(".//td[@class='username column-username has-row-actions column-primary'][1]/strong").text == Benutzername    
...
def step_impl(context):
    ...
    assert driver.find_element_by_xpath("//*[@id='login_error']").text == "FEHLER: Das Passwort, das du für den Benutzernamen root eingegeben hast, ist nicht korrekt. Passwort vergessen?"
...
def step_impl(context):
    ...
    assert driver.find_element_by_xpath("//*[@id='login_error']").text == "FEHLER: Ungültiger Benutzername. Passwort vergessen?"
